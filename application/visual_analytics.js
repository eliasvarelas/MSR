...
var option = document.getElementById('type_of_chart');

// function axisAppear() {

//     if (option.value == 'vert_bar' || option.value == 'line_chart') {
...
//     } else if (option.value == 'Pie_chart' || option.value == 'donut_chart') {
...
function names() {
    ...
    if (option.value == "Pie_chart") {
        ...
        // ];
        var data = d3.json("/MSR/application/empdata.json", function(data) {
            console.log(data);
        });
